...
def save_identities(dataset, path):
...
def predict_identity(frame,rejection_threshold=0.5):
    feature_vector = extract_features(face_reco_model, frame).reshape(-1,2048)
